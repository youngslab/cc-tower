...
program
    ...
    if (opts.picker) {
        ...
        const { waitUntilExit } = render(React.createElement(App, { tower, pickerMode: true, outputPath: opts.output, originPaneId: opts.originPane }), renderOpts);
        try {
            await waitUntilExit();
        }
        catch { }
...
program
    ...
    const queryRunning = () => new Promise((resolve) => {
