...
export function Dashboard({ sessions, tmuxCount, maxTaskWidth, onSelect, onSend, onPeek, onToggleFavorite, onQuit }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", children: [_jsxs(Box, { marginBottom: 1, children: [_jsx(Text, { bold: true, color: "cyan", children: "cc-tower" }), _jsxs(Text, { children: [" \u2014 ", sorted.length, " sessions"] })] }), _jsxs(Box, { children: [_jsx(Text, { bold: true, children: "   " }), _jsx(Text, { bold: true, dimColor: true, children: pad('PANE', 7) }), _jsx(Text, { bold: true, dimColor: true, children: pad('HOST', 9) }), _jsx(Text, { bold: true, dimColor: true, children: pad('LABEL', 18) }), _jsx(Text, { bold: true, dimColor: true, children: pad('STATUS', 14) }), _jsx(Text, { bold: true, dimColor: true, children: "GOAL" })] }), sorted.map((session, i) => {
