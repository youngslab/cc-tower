...
export function NewSession({ projects, hosts, onSelect, onCancel, getPastSessions, getPastSessionsByTarget, getAllPastSessions, onDeleteSession }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", children: [_jsx(Text, { bold: true, color: "cyan", children: "New Claude Session" }), mode === 'recent' ? (_jsxs(_Fragment, { children: [_jsx(Text, { bold: true, color: "cyan", children: "Recent Sessions" }), _jsx(Text, { children: " " }), recentSessions.length === 0 ? (_jsx(Text, { dimColor: true, children: "  No past sessions" })) : (recentSessions.map((s, i) => {
                        ...
                        return (_jsxs(Box, { flexDirection: "column", children: [_jsxs(Box, { children: [_jsx(Text, { color: sel ? 'cyan' : undefined, bold: sel, children: sel ? '▸ ' : '  ' }), _jsx(Text, { color: sel ? 'cyan' : undefined, bold: sel, children: displayName }), _jsxs(Text, { dimColor: true, children: ["  [", hostBadge, "]  ", s.cwd, "  \u00B7  ", formatAge(s.startedAt)] })] }), summary && sel && (_jsxs(Text, { dimColor: true, children: ["    ", summary.length > 72 ? summary.slice(0, 71) + '…' : summary] }))] }, s.sessionId));
                        ...
                        const displayName = s.label ? `${dirName} [${s.label}]` : dirName;
                        const summary = s.contextSummary ?? s.goalSummary;
                        return (_jsxs(Box, { flexDirection: "column", children: [_jsxs(Box, { children: [_jsx(Text, { color: sel ? 'cyan' : undefined, bold: sel, children: sel ? '▸ ' : '  ' }), _jsx(Text, { color: sel ? 'cyan' : undefined, bold: sel, children: displayName }), _jsxs(Text, { dimColor: true, children: ["  ", s.cwd, "  \u00B7  ", formatAge(s.startedAt)] })] }), summary && sel && (_jsxs(Text, { dimColor: true, children: ["    ", summary.length > 72 ? summary.slice(0, 71) + '…' : summary] }))] }, s.sessionId));
                        ...
                        return (_jsxs(Box, { flexDirection: "column", children: [_jsxs(Box, { children: [_jsx(Text, { color: isSelected ? 'cyan' : undefined, bold: isSelected, children: isSelected ? '▸ ' : '  ' }), _jsxs(Text, { color: isSelected ? 'cyan' : 'white', children: ["Resume", s.label ? ` [${s.label}]` : ''] }), _jsxs(Text, { dimColor: true, children: [" \u00B7 ", age] })] }), summary && (_jsxs(Text, { dimColor: true, children: ["    ", summary.length > 80 ? summary.slice(0, 79) + '…' : summary] }))] }, s.sessionId));
