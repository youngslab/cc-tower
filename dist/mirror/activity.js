...
export function activityPath(host, pane) {
...
export function touchActivity(host, pane) {
...
export function getActivityMtime(host, pane) {
    try {
...
export function clearActivity(host, pane) {
    try {
        fs.unlinkSync(activityPath(host, pane));
    }
    catch { }
}
