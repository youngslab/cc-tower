...
export class JsonlWatcher extends EventEmitter {
     ...
     */
    coldStartCustomTitle(jsonlPath) {
        try {
     ...
     */
    async readLatestActivity(jsonlPath) {
        try {
            const stat = fs.statSync(jsonlPath);
     ...
     */
    async readRecentContext(jsonlPath, maxMessages = 15) {
        try {
            const stat = fs.statSync(jsonlPath);
