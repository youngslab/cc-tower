        ...
        return (
          <React.Fragment key={session.sessionId}>
            ...
            <Box>
              ...
              <Text dimColor={isDim}>{session.summaryLoading ? '⟳ summarizing...' : truncate(session.contextSummary ?? session.currentActivity ?? session.currentTask ?? '(no data)', maxTaskWidth)}</Text>
            </Box>
          </React.Fragment>
        );
      })}
